...
$result = mysqli_query($connect,"SELECT *,AES_DECRYPT(doc_id,'1111'),AES_DECRYPT(p_id,'1111'),AES_DECRYPT(diagnosis,'1111'),AES_DECRYPT(prescription,'1111') FROM treatment");
?>
...
echo "<td>" . $row["AES_DECRYPT(diagnosis,'1111')"] . "</td>";
echo "<td>" . $row["AES_DECRYPT(prescription,'1111')"] . "</td>";
echo "</tr>";
}
?>
</table>
